...
import homework.hw11.HW11;
import homework.hw12.HW12;
import homework.hw13.HW13;
        ...
        if (numbers != null) {
            for (int number : numbers) {
                switch (number) {
                    ...
                    case 11: {
                        AbstractHomework hw = new HW11();
                        runTasks(hw);
                        break;
                    }
                    case 12: {
                        AbstractHomework hw = new HW12();
                        runTasks(hw);
                        break;
                    }
                    case 13: {
                        AbstractHomework hw = new HW13();
                        runTasks(hw);
                        break;
                    }
                    default: {
